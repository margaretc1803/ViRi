# Asset inventory — project/dist-elevated/assets
...
| File | In use | Source | Rights |
| --- | --- | --- | --- |
| `barre-balls.jpg` | yes | not recorded | Not recorded. Supplied by Margaret or added during the redesign; treat as third-party and unl… |
| `barre-white.jpg` | yes | not recorded | Not recorded. Supplied by Margaret or added during the redesign; treat as third-party and unl… |
...
| `brand-solidcore-blue.jpg` | — | https://richmondbizsense.com/2018/09/07/greengate… | Copyright retained by source/photographer; no explicit reuse license verified. |
| `brand-soulcycle.jpg` | yes | https://www.soul-cycle.com/soulconnected/instruct… | Copyright retained by source/photographer; no explicit reuse license verified. |
| `caveat-OFL.txt` | — | not recorded | Not recorded. Supplied by Margaret or added during the redesign; treat as third-party and unl… |
| `caveat.woff` | — | https://github.com/google/fonts/tree/main/ofl/caveat | SIL Open Font License 1.1; included as caveat-OFL.txt |
| `coffee-table.jpg` | — | not recorded | Not recorded. Supplied by Margaret or added during the redesign; treat as third-party and unl… |
...
| `hero-mats.jpg` | yes | https://newsnetwork.mayoclinic.org/discussion/may… | Copyright retained by source/photographer; no explicit reuse license verified. |
...
None of this photography is cleared for public use. The studio press shots are the studios' own,
the lifestyle photographs are third-party, and the two typefaces that ship as files
(`caveat.woff`, with its OFL licence beside it) are the only assets here with an explicit licence.
This has to be settled before the site is shown outside a private review — alongside the studio
brand names, which appear throughout with invented class schedules under them.

## Retired files

These are unreferenced. They are kept because they may be wanted again; delete them freely if not.

- `brand-clubpilates.webp`
- `brand-corepower.webp`
- `brand-purebarre-barre.jpg`
- `brand-purebarre.jpg`
- `brand-solidcore-blue.jpg`
- `caveat-OFL.txt`
- `caveat.woff`
- `coffee-table.jpg`
- `pin-balls.jpg`
